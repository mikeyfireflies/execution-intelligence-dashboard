...
function normalizeGoal(page) {
  ...
  // Contributors: separate Notion people field
  const contributors = extractPeopleArray(page, FIELD_MAP.contributors);
  ...
  const role = extractProperty(page, FIELD_MAP.role);
