// Use crypto.randomUUID() which is available in both Node.js and Edge runtimes
export class NextJSSETransport {
    constructor(endpoint, controller) {
        this.endpoint = endpoint;
        this.controller = controller;
        this.sessionId = crypto.randomUUID ? crypto.randomUUID() : Math.random().toString(36).substring(2, 15);
        this.onclose = null;
        this.onerror = null;
        this.onmessage = null;
    }
